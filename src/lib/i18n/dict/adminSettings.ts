...
export const adminSettings: DictModule = {
  ...
  'as.cancel': { hy: 'Չեղարկել', ru: 'Отмена', en: 'Cancel' },

  // ── Delivery: zones economics + rules (admin) ──
  'ad.tabZones': { hy: 'Գոտիներ', ru: 'Зоны', en: 'Zones' },
  'ad.tabRules': { hy: 'Կանոններ', ru: 'Правила', en: 'Rules' },
  'ad.price': { hy: 'Արժեք (֏)', ru: 'Стоимость (֏)', en: 'Price (֏)' },
  'ad.freeThreshold': { hy: 'Անվճար շեմ', ru: 'Порог бесплатной', en: 'Free threshold' },
  'ad.freeThresholdPh': { hy: 'Ընդհանուրի փոխարեն', ru: 'Переопределяет общий', en: 'Overrides global' },
  'ad.eta': { hy: 'Ժամկետ', ru: 'Срок', en: 'ETA' },
  'ad.etaPh': { hy: 'Օր.՝ 1–2 օր', ru: 'Напр.: 1–2 дня', en: 'e.g. 1–2 days' },
  'ad.keywords': { hy: 'Բանալի բառեր (հասցեի ճանաչման համար)', ru: 'Ключевые слова (для распознавания адреса)', en: 'Keywords (for address detection)' },
  'ad.keywordsPh': { hy: 'ստորակետով բաժանված', ru: 'через запятую', en: 'comma-separated' },
  'ad.inactive': { hy: 'Անջատված', ru: 'Выключено', en: 'Inactive' },
  'ad.rulesHint': { hy: 'Բացառություններ՝ կիրառվում են ըստ առաջնահերթության, առաջին համընկնողը հաղթում է', ru: 'Исключения: применяются по приоритету, побеждает первое совпадение', en: 'Exceptions: applied by priority, first match wins' },
  'ad.noRules': { hy: 'Կանոններ դեռ չկան', ru: 'Правил пока нет', en: 'No rules yet' },
  'ad.newRule': { hy: 'Նոր կանոն', ru: 'Новое правило', en: 'New rule' },
  'ad.editRule': { hy: 'Խմբագրել կանոնը', ru: 'Редактировать правило', en: 'Edit rule' },
  'ad.ruleName': { hy: 'Կանոնի անվանումը', ru: 'Название правила', en: 'Rule name' },
  'ad.ruleNameRequired': { hy: 'Նշեք կանոնի անվանումը', ru: 'Укажите название правила', en: 'Enter a rule name' },
  'ad.effect': { hy: 'Էֆեկտ', ru: 'Эффект', en: 'Effect' },
  'ad.effect.free': { hy: 'Անվճար', ru: 'Бесплатно', en: 'Free' },
  'ad.effect.fixed': { hy: 'Ֆիքսված գին', ru: 'Фикс. цена', en: 'Fixed price' },
  'ad.effect.percent': { hy: 'Զեղչ %', ru: 'Скидка %', en: 'Discount %' },
  'ad.percentOff': { hy: 'Զեղչ %', ru: 'Скидка %', en: '% off' },
  'ad.fixedPrice': { hy: 'Գին (֏)', ru: 'Цена (֏)', en: 'Price (֏)' },
  'ad.priority': { hy: 'Առաջնահերթություն', ru: 'Приоритет', en: 'Priority' },
  'ad.group': { hy: 'Խումբ', ru: 'Группа', en: 'Group' },
  'ad.anyGroup': { hy: 'Ցանկացած', ru: 'Любая', en: 'Any' },
  'ad.minOrder': { hy: 'Նվազ. գումար (֏)', ru: 'Мин. сумма (֏)', en: 'Min order (֏)' },
  'ad.anyAmount': { hy: 'Ցանկացած', ru: 'Любая', en: 'Any' },
  'ad.weekdays': { hy: 'Շաբաթվա օրեր', ru: 'Дни недели', en: 'Weekdays' },
  'ad.weekdaysHint': { hy: 'Դատարկ՝ բոլոր օրերը', ru: 'Пусто = все дни', en: 'Empty = every day' },
  'ad.dateFrom': { hy: 'Ամսաթիվ-ից', ru: 'Дата с', en: 'Date from' },
  'ad.dateTo': { hy: 'Ամսաթիվ-մինչև', ru: 'Дата по', en: 'Date to' },
  'ad.specificZones': { hy: 'Կոնկրետ գոտիներ', ru: 'Конкретные зоны', en: 'Specific zones' },
  'ad.zonesHint': { hy: 'Դատարկ՝ ամբողջ խումբը', ru: 'Пусто = вся группа', en: 'Empty = whole group' },
  'ad.zonesShort': { hy: 'գոտի', ru: 'зон', en: 'zones' },
  'ad.note': { hy: 'Նշում հաճախորդի համար', ru: 'Заметка для клиента', en: 'Customer note' },
  'ad.step.basics': { hy: 'Հիմնական', ru: 'Основное', en: 'Basics' },
  'ad.step.scope': { hy: 'Պայմաններ', ru: 'Условия', en: 'Conditions' },
  'ad.step.note': { hy: 'Նշում', ru: 'Заметка', en: 'Note' },
  'ad.next': { hy: 'Հաջորդ', ru: 'Далее', en: 'Next' },
  'ad.back': { hy: 'Հետ', ru: 'Назад', en: 'Back' },
  'ad.dow.0': { hy: 'Կիր', ru: 'Вс', en: 'Sun' },
  'ad.dow.1': { hy: 'Երկ', ru: 'Пн', en: 'Mon' },
  'ad.dow.2': { hy: 'Երեք', ru: 'Вт', en: 'Tue' },
  'ad.dow.3': { hy: 'Չրք', ru: 'Ср', en: 'Wed' },
  'ad.dow.4': { hy: 'Հնգ', ru: 'Чт', en: 'Thu' },
  'ad.dow.5': { hy: 'Ուրբ', ru: 'Пт', en: 'Fri' },
  'ad.dow.6': { hy: 'Շաբ', ru: 'Сб', en: 'Sat' },
};
