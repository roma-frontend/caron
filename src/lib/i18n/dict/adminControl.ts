...
export const adminControl: DictModule = {
  ...
  'sec.step2': { hy: 'Ավելացրեք բանալին ձեր authenticator հավելվածում, ապա մուտքագրեք կոդը', ru: 'Добавьте ключ в приложение-аутентификатор, затем введите код', en: 'Add the key to your authenticator app, then enter the code' },
  'sec.manualKey': { hy: 'Բանալի (ձեռքով մուտք)', ru: 'Ключ (ручной ввод)', en: 'Key (manual entry)' },
