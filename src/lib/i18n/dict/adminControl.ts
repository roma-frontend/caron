...
export const adminControl: DictModule = {
  ...
  'nav.security': { hy: 'Անվտանգություն', ru: 'Безопасность', en: 'Security' },

  // --- Two-factor / security page ---
  'sec.title': { hy: 'Անվտանգություն · 2FA', ru: 'Безопасность · 2FA', en: 'Security · 2FA' },
  'sec.subtitle': { hy: 'Երկգործոն նույնականացում ձեր հաշվի համար', ru: 'Двухфакторная аутентификация для вашего аккаунта', en: 'Two-factor authentication for your account' },
  'sec.statusOn': { hy: '2FA միացված է', ru: '2FA включена', en: '2FA is enabled' },
  'sec.statusOff': { hy: '2FA անջատված է', ru: '2FA отключена', en: '2FA is disabled' },
  'sec.enable': { hy: 'Միացնել 2FA', ru: 'Включить 2FA', en: 'Enable 2FA' },
  'sec.enableHint': { hy: 'Օգտագործեք authenticator հավելված (Google Authenticator, Authy և այլն)', ru: 'Используйте приложение-аутентификатор (Google Authenticator, Authy и т.п.)', en: 'Use an authenticator app (Google Authenticator, Authy, etc.)' },
  'sec.step2': { hy: 'Սկանավորեք QR-ը authenticator հավելվածով, ապա մուտքագրեք կոդը', ru: 'Отсканируйте QR в приложении-аутентификаторе, затем введите код', en: 'Scan the QR in your authenticator app, then enter the code' },
  'sec.scanQr': { hy: 'Սկանավորեք այս QR-ը հավելվածով', ru: 'Отсканируйте этот QR приложением', en: 'Scan this QR with the app' },
  'sec.manualKey': { hy: 'Կամ ձեռքով մուտքագրեք բանալին', ru: 'Или введите ключ вручную', en: 'Or enter the key manually' },
  'sec.enterCode': { hy: '6-նիշանոց կոդ', ru: '6-значный код', en: '6-digit code' },
  'sec.confirmEnable': { hy: 'Հաստատել և միացնել', ru: 'Подтвердить и включить', en: 'Confirm & enable' },
  'sec.enabled': { hy: '2FA միացվեց', ru: '2FA включена', en: '2FA enabled' },
  'sec.disable': { hy: 'Անջատել 2FA', ru: 'Отключить 2FA', en: 'Disable 2FA' },
  'sec.disableLabel': { hy: 'Մուտքագրեք կոդ՝ անջատելու համար', ru: 'Введите код для отключения', en: 'Enter a code to disable' },
  'sec.disabled': { hy: '2FA անջատվեց', ru: '2FA отключена', en: '2FA disabled' },
  'sec.confirmDisable': { hy: 'Անջատե՞լ 2FA-ն', ru: 'Отключить 2FA?', en: 'Disable 2FA?' },
  'sec.recoveryTitle': { hy: 'Վերականգնման կոդեր', ru: 'Коды восстановления', en: 'Recovery codes' },
  'sec.recoveryHint': { hy: 'Պահեք դրանք ապահով տեղում։ Յուրաքանչյուրը գործում է մեկ անգամ, եթե կորցնեք սարքը', ru: 'Сохраните их в надёжном месте. Каждый работает один раз — на случай потери устройства', en: 'Keep them safe. Each works once, in case you lose your device' },
  'sec.recoveryRemaining': { hy: 'Մնացած վերականգնման կոդեր', ru: 'Осталось кодов восстановления', en: 'Recovery codes remaining' },
  'sec.copy': { hy: 'Պատճենել', ru: 'Копировать', en: 'Copy' },
  'sec.copied': { hy: 'Պատճենվեց', ru: 'Скопировано', en: 'Copied' },
  'sec.code6': { hy: 'Կոդը պետք է լինի 6 նիշ', ru: 'Код должен состоять из 6 цифр', en: 'Code must be 6 digits' },
  'sec.codeToDisable': { hy: 'Մուտքագրեք կոդ', ru: 'Введите код', en: 'Enter a code' },
  'sec.codeInvalid': { hy: 'Սխալ կոդ', ru: 'Неверный код', en: 'Invalid code' },
  'sec.error': { hy: 'Սխալ', ru: 'Ошибка', en: 'Error' },
