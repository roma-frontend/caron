...
const buildCsp = (extraScriptSrc = '') => [
  `default-src 'self'`,
  `script-src 'self' 'unsafe-inline' https://va.vercel-scripts.com https://telegram.org https://challenges.cloudflare.com https://static.cloudflareinsights.com${extraScriptSrc}${isDev ? " 'unsafe-eval'" : ''}`,
  `style-src 'self' 'unsafe-inline'`,
  `img-src 'self' data: blob: https:`,
  `media-src 'self' blob: https://*.r2.dev https://*.r2.cloudflarestorage.com https://img.caron.group`,
  `font-src 'self' data:`,
  `connect-src 'self' https://*.convex.cloud wss://*.convex.cloud https://*.convex.site https://*.r2.dev https://*.r2.cloudflarestorage.com https://img.caron.group https://challenges.cloudflare.com https://cloudflareinsights.com https://vitals.vercel-insights.com`,
...
const securityHeaders = [
  ...
  { key: 'Permissions-Policy', value: 'camera=(), microphone=(self), geolocation=(), payment=(), usb=(), browsing-topics=(), run-ad-auction=(), join-ad-interest-group=(), shared-storage=(), shared-storage-select-url=()' },
