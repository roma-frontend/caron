...
export const get = query({
  ...
  handler: async (ctx, args) => {
    ...
    return settings ?? {
      ...
      bankCode: 'AMRNAM22',
      cardNumber: '',
      paymentNote: 'Հաշվի համար: 1570000000000000 • Ameriabank • Caron LLC',
      gaId: '',
      fbPixelId: '',
      ...
      loyaltyPercent: 1,
      loyaltyTiers: [],
      loyaltyReviewPoints: 20,
      loyaltyReviewPhotoBonus: 30,
      referralReward: 100,
  ...
  handler: async (ctx, args) => {
    ...
    if (existing) {
      ...
      await ctx.db.insert('settings', {
        storeName: args.storeName ?? 'Caron Armenia',
        phone: args.phone ?? '',
        email: args.email ?? '',
        ...
        announcementEnabled: args.announcementEnabled ?? true,
        showCategories: args.showCategories ?? true,
        showFeatured: args.showFeatured ?? true,
        showBrands: args.showBrands ?? true,
        showFeatures: args.showFeatures ?? true,
        enableCarSelector: args.enableCarSelector ?? true,
        enablePriceFilter: args.enablePriceFilter ?? true,
        enableReviews: args.enableReviews ?? true,
        navBadges: args.navBadges ?? undefined,
        ...
        loyaltyTiers: args.loyaltyTiers ?? [],
        loyaltyReviewPoints: args.loyaltyReviewPoints ?? 20,
        loyaltyReviewPhotoBonus: args.loyaltyReviewPhotoBonus ?? 30,
        referralReward: args.referralReward ?? 100,
        deliveryDaysYerevan: args.deliveryDaysYerevan,
        deliveryDaysRegions: args.deliveryDaysRegions,
